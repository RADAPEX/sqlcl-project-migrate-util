...
prompt **                                               **
prompt **                     USAGE                     **
prompt **       From the parent dir to sqlutil:         **
prompt **  @./sqlutil/proj-init-mig <your-new-migration-repo> <schema_to_migrate>
prompt **                                               **
prompt ***************************************************
prompt
...
prompt
prompt Make a symbolic link to login.sql in the new repo and .gitignore it from the repo
prompt THIS LOGIN FILE NEEDS AMENDING FOR YOUR ADB WALLET PATH
prompt THIS LOGIN FILE NEEDS AMENDING FOR YOUR ADB WALLET PATH
prompt THIS LOGIN FILE NEEDS AMENDING FOR YOUR ADB WALLET PATH
!ln -s &tmplts/login.sql login.sql
...
prompt
prompt
prompt Copy in the RadApex standard SQL format definition over the auto-generated one, and
...
prompt
prompt
prompt `stage` a custom file into this release to set the schema appropriately at the outset
prompt
project stage add-custom -file-name set_schema.sql
!cat &tmplts/set_schema.sql >> ./dist/releases/next/changes/sqlcl-project-migration/_custom/set_schema.sql
